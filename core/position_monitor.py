...
class SourceState(_GeometryMixin, _EntryMixin, _HelpersMixin,
    ...
    def _check_legs(self):
        ...
        # ── Trailing SL: follows price after R2 locks the SL ────────
        self._check_trailing_sl(buy_pos, sell_pos)

        # ── R3 Partial Exit: close 70% when price reaches TP ───────
        self._check_partial_exit_r3(buy_pos, sell_pos)
